...
La source de vérité est Figma. Les 144 variables sont exportées dans `tokens/*.tokens.json` (4 modes :
...
Même contrat que les tokens, même raison. Les 20 icônes sont les composants de la page Figma
