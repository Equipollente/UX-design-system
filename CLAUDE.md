...
La source de vérité est Figma. Les 146 variables sont exportées dans `tokens/*.tokens.json` (4 modes :
...
Même contrat que les tokens, même raison. Les 21 icônes sont les composants de la page Figma
