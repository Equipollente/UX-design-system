...
| Composant | Nœud | Code |
| --- | --- | --- |
| Icon (les 26 icônes) | [`45-395`](https://www.figma.com/design/uQ5j90wu2MJSvzsN3Oc0pT/UX-design-system?node-id=45-395) | [Icon.astro](src/design-system/components/Icon.astro), registre généré dans [icons.ts](src/design-system/lib/icons.ts) |
...
| CardDefault | [`451-1004`](https://www.figma.com/design/uQ5j90wu2MJSvzsN3Oc0pT/UX-design-system?node-id=451-1004) | [CardDefault.astro](src/design-system/components/CardDefault.astro) |
...
| Tabs (famille : Tabs, TabList, TabButton, TabPanel) | [`531-3521`](https://www.figma.com/design/uQ5j90wu2MJSvzsN3Oc0pT/UX-design-system?node-id=531-3521) | [tabs/](src/design-system/components/tabs) |
